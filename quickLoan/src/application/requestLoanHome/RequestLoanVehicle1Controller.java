...
public class RequestLoanVehicle1Controller {
    ...
    void confirm(ActionEvent event) {
    	 Loan loan = new Loan();
    	    ...
    	    if (LoanModel.create(loan)) {
    	    	try {
    	    		FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/requestLoanHome/requestLoanVehiclePage2.fxml"));
