...
public class RequestLoanVehicleController implements Initializable {
    ...
    void getStarted(ActionEvent event) {
    	try {
    		FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/requestLoanHome/requestLoanVehiclePage1.fxml"));
    		Parent root = loader.load();
    		
    		// Get the Controller from loader
            RequestLoanVehicle1Controller controller = loader.getController();
